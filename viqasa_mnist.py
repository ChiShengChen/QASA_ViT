...
if __name__ == "__main__":
    ...
    best_model_path = "checkpoints_mnist/best_model.pth"
    log_path = "mnist_training.log"
    ...
    logger.info("Starting training for MNIST with VisionHybridTransformer.")
    ...
    plt.legend()
    plt.grid(True)
    plot_path = "loss_plot_mnist.png"
    plt.savefig(plot_path)
    logger.info(f"Loss plot saved to {plot_path}")

    # 7. Save history log
    history_path = "checkpoints_mnist/history.json"
