...
if __name__ == "__main__":
    ...
    os.makedirs("checkpoints_transformer_fashion_mnist", exist_ok=True)
    best_model_path = "checkpoints_transformer_fashion_mnist/best_model.pth"
    log_path = "transformer_fashion_mnist_training.log"
    ...
    logger.info("Starting training for Fashion MNIST with VisionTransformer.")
    ...
    plt.legend()
    plt.grid(True)
    plot_path = "loss_plot_transformer_fashion_mnist.png"
